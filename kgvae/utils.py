...
def negative_sampling(pos_samples, num_entity, negative_rate):
    ...
    # only sampling the tails entities
...
def perturb_and_get_rank(embedding, w, a, r, b, test_size, batch_size=100, all_batches=True, decoder_method="RotateE",
    ...
    for idx in range(n_batch):  # n_batch TODO
        ...
        if decoder_method == 'DistMult':
            ...
            phase_relation = relations / ((gamma + epsilon) / re_head.shape[-1] / np.pi)
...
def calc_mrr(embedding, w, test_triplets, hits=[], eval_bz=100, all_batches=True):
    with torch.no_grad():
        ...
        ranks = perturb_and_get_rank(embedding, w, o, r, s, test_size, eval_bz, all_batches)
